...
void Application::Execute()
{
	...
	while (1)
	{
		...
		//ImGui Demo ウィンドウ表示　※すごく参考になるウィンドウです。imgui_demo_cpp参照
		//ImGui::ShowDemoWindow(nullptr);
		Scene::GetInstance().ImGuiUpdate();

		//バックバッファクリア
		D3D.GetDevContext()->ClearRenderTargetView(D3D.GetBackBuffer()->GetRTView(),Math::Color(0.0f, 0.0f, 1.0f, 1.0f));//青色
